...
DISK_IMAGE="${1:-}"
SOURCE="${REPO_ROOT}/tools/hydrarpc_multiclient_dedicated_send1_poll1.c"
BUILD_DIR="${REPO_ROOT}/output/hydrarpc_multiclient_dedicated_guest"
BINARY_NAME="hydrarpc_multiclient_dedicated_send1_poll1"
...
#!/bin/sh
set -eu
exec numactl -N 0 -m 0 /home/test_code/hydrarpc_multiclient_dedicated_send1_poll1 "$@"
EOF
