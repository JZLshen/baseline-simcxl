...
DISK_IMAGE="${1:-}"
SOURCE="${REPO_ROOT}/tools/hydrarpc_multiclient_shared.c"
BUILD_DIR="${REPO_ROOT}/output/hydrarpc_multiclient_shared_guest"
BINARY_NAME="hydrarpc_multiclient_shared"
...
#!/bin/sh
set -eu
exec numactl -N 0 -m 0 /home/test_code/hydrarpc_multiclient_shared "$@"
EOF
